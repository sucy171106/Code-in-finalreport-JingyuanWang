...
# introduce noise = 0 into the labels
noise_ratio = 0
...
with open('q0testerrs.csv', 'w', encoding='utf-8', newline='') as file_obj:
    # create the object
    writer = csv.writer(file_obj)
    writer.writerow((testerrs))

# export the number of support vectors in CSV file
with open('q0n_supports.csv', 'w', encoding='utf-8', newline='') as file_obj:
    # create the object
    writer = csv.writer(file_obj)
    writer.writerow((n_supports))

# export the train error in CSV file
with open('q0trainerrs.csv', 'w', encoding='utf-8', newline='') as file_obj:
    # create the object
    writer = csv.writer(file_obj)
    writer.writerow((trainerrs))

# export the norm of the coefficients in CSV file
with open('q0ws.csv', 'w', encoding='utf-8', newline='') as file_obj:
    # create the object
    writer = csv.writer(file_obj)
    writer.writerow((ws))
