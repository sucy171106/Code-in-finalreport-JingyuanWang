...
# difine the function of SVM
clf = SVC(kernel='linear',C=64)


# introduce noise = 0.1 into the labels
noise_ratio = 0.1
...
with open('q1testerrs.csv', 'w', encoding='utf-8', newline='') as file_obj:
    # create the object
    writer = csv.writer(file_obj)
    writer.writerow((testerrs))

# export the number of support vectors in CSV file
with open('q1n_supports.csv', 'w', encoding='utf-8', newline='') as file_obj:
    # create the object
    writer = csv.writer(file_obj)
    writer.writerow((n_supports))

# export the train error in CSV file
with open('q1trainerrs.csv', 'w', encoding='utf-8', newline='') as file_obj:
    # create the object
    writer = csv.writer(file_obj)
    writer.writerow((trainerrs))

# export the norm of the coefficients in CSV file
with open('q1ws.csv', 'w', encoding='utf-8', newline='') as file_obj:
    # create the object
    writer = csv.writer(file_obj)
    writer.writerow((ws))
